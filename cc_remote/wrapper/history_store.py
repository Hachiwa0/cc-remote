...
# the source-complete event size before their lightweight turns were materialized.
_SCHEMA_VERSION = 18
...
class MaterializedHistoryPage:
    ...
    # user-item id without appending another source record first.  Bind an
    # active newest-page projection to the complete source-proven task set so
    # an exact fingerprint cache hit cannot replay an old terminal boundary.
    # This is private rebuildable-index metadata, not part of the wire schema.
