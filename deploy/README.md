...
Protocol v36 is a coordinated upgrade: publish freshly built Relay/Web and
...
activate the v36 relay/web release; then start the v36 wrapper.
...
verify v36, and retain that snapshot with the previous release. To roll back,
stop v36, run `work_registry_snapshot.py restore`, then switch and start the old
